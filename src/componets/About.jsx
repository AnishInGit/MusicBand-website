...
function About() {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">Our Team Members</h2>
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Passion for music is top notch and gives the ultimate power to live life. Music that motivate us to more creative. </p>
      </div> 
      <div class="grid gap-8 lg:gap-16 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-5">
          <div class="text-center text-gray-500 dark:text-gray-400">
              ...
              <ul class="flex justify-center mt-4 space-x-4">
                  ...
                  <li>
                      <a href="/admin" class="text-[#ea4c89] hover:text-gray-900 dark:hover:text-white">
...
<footer className='bg-black text-white p-4'> Copyright &copy; 2024 All Rights Reserved </footer>
    </>
  )
}
